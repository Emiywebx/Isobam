      ...
      <!-- Google Translator -->      
       <div style="position: relative; right: 15px; top: 5px;">
        ...
        <div class="navbar-nav mr-auto py-0">
          <a href="faq.php" class="nav-item nav-link active">FAQs</a>
...
<div class="row pt-5">
  ...
  <div class="col-lg-5 col-md-12 mb-5">
    ...
    <p>
      Kindly Subscribe to get more Update from us!
    </p>
    <div class="w-100">
        <form name="submit-to-google-sheet" method="post" action="data.php" class="input-group input-group-append">
        <input
          type="email"
          name="email_news"
          ...
          required/>
          <button type="submit" name="submit" class="btn btn-primary px-4">Subscribe</button>
        </form>
